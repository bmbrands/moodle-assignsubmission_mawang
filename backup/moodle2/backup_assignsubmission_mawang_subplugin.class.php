...
class backup_assignsubmission_mawang_subplugin extends backup_subplugin {
    ...
    protected function define_submission_subplugin_structure() {
        ...
        $subpluginelement = new backup_nested_element('mawang_value', ['id'], [
        ...
        $subpluginelement->set_source_table('assignsubmission_mawang_value', ['submissionid' => backup::VAR_PARENTID]);
        return $subplugin;
    }
}
