...
class backup_assignsubmission_mawang_subplugin extends backup_subplugin {
    ...
    protected function define_submission_subplugin_structure() {
        ...
        $subpluginelement = new backup_nested_element('submission_mawang', null, ['value', 'submission']);
        ...
        $subpluginelement->annotate_files('assignsubmission_mawang', 'fileareaname', 'submission');
